      ...
      <div className="container-fluid bg-content">
        ...
        <div className="row text-center justify-content-center">
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            <a href="https://m.pg-demo.com/rise-of-apollo/index.html?__refer=m.pg-redirect.com&__sv=0&language=en-US,en;q=0.9&bet_type=2&operator_token=8735ze6y8kp7jpwmxvau7gvytu3adwj4&from=https://dev.pgslot.co/home" target="_blank" rel="noreferrer" >
              <img src="img/pgslot1.jpg" className="img-fluid" width="180px" height="241px" alt="pg slot" />
            </a>
          ...
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            <a href="https://m.pg-demo.com/bali-vacation/index.html?__refer=m.pg-redirect.com&__sv=0&language=en-US,en;q=0.9&bet_type=2&operator_token=8735ze6y8kp7jpwmxvau7gvytu3adwj4&from=https://dev.pgslot.co/home" target="_blank" rel="noreferrer">
              <img src="img/pgslot2.jpg" className="img-fluid" width="180px" height="241px" alt="pg slot" />
            </a>
            <div className="card-body">
              <strong>Bali Vacation</strong>
            </div>
          </div>
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            <a href="https://m.pg-demo.com/wild-bandito/index.html?__refer=m.pg-redirect.com&__sv=0&language=en-US,en;q=0.9&bet_type=2&operator_token=8735ze6y8kp7jpwmxvau7gvytu3adwj4&from=https://dev.pgslot.co/home" target="_blank" rel="noreferrer">
              <img src="img/pgslot3.jpg" className="img-fluid" width="180px" height="241px" alt="pg slot" />
            </a>
            <div className="card-body">
              <strong>Wild Bandito</strong>
            </div>
          </div>
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            <a href="https://m.pg-demo.com/candy-burst/index.html?__refer=m.pg-redirect.com&__sv=0&language=en-US,en;q=0.9&bet_type=2&operator_token=8735ze6y8kp7jpwmxvau7gvytu3adwj4&from=https://dev.pgslot.co/home" target="_blank" rel="noreferrer">
              <img src="img/pgslot4.jpg" className="img-fluid" width="180px" height="241px" alt="pg slot" />
            </a>
            <div className="card-body">
              <strong>Candy Bonanza</strong>
            </div>
          </div>
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            <a href="https://m.pg-demo.com/circus-delight/index.html?__refer=m.pg-redirect.com&__sv=0&language=en-US,en;q=0.9&bet_type=2&operator_token=8735ze6y8kp7jpwmxvau7gvytu3adwj4&from=https://dev.pgslot.co/home" target="_blank" rel="noreferrer">
              <img src="img/pgslot5.jpg" className="img-fluid" width="180px" height="241px" alt="pg slot" />
            </a>
            <div className="card-body">
              <strong>Circus Delight</strong>
            </div>
          </div>
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            <a href="https://m.pg-demo.com/crypto-gold/index.html?__refer=m.pg-redirect.com&__sv=0&language=en-US,en;q=0.9&bet_type=2&operator_token=8735ze6y8kp7jpwmxvau7gvytu3adwj4&from=https://dev.pgslot.co/home" target="_blank" rel="noreferrer">
              <img src="img/pgslot6.jpg" className="img-fluid" width="180px" height="241px" alt="pg slot" />
            </a>
            <div className="card-body">
              <strong>Crypto Gold</strong>
            </div>
          </div>
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            <a href="https://m.pg-demo.com/dreams-of-macau/index.html?__refer=m.pg-redirect.com&__sv=0&language=en-US,en;q=0.9&bet_type=2&operator_token=8735ze6y8kp7jpwmxvau7gvytu3adwj4&from=https://dev.pgslot.co/home" target="_blank" rel="noreferrer">
              <img src="img/pgslot7.jpg" className="img-fluid" width="180px" height="241px" alt="pg slot" />
            </a>
            <div className="card-body">
              <strong>Dreams of Macau</strong>
            </div>
          </div>
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            <a href="https://m.pg-demo.com/fortune-ox/index.html?__refer=m.pg-redirect.com&__sv=0&language=en-US,en;q=0.9&bet_type=2&operator_token=8735ze6y8kp7jpwmxvau7gvytu3adwj4&from=https://dev.pgslot.co/home" target="_blank" rel="noreferrer">
              <img src="img/pgslot8.jpg" className="img-fluid" width="180px" height="241px" alt="pg slot" />
            </a>
            <div className="card-body">
              <strong>Fortune Ox</strong>
            </div>
          </div>
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            <a href="https://m.pg-demo.com/galactic-gems/index.html?__refer=m.pg-redirect.com&__sv=0&language=en-US,en;q=0.9&bet_type=2&operator_token=8735ze6y8kp7jpwmxvau7gvytu3adwj4&from=https://dev.pgslot.co/home" target="_blank" rel="noreferrer">
              <img src="img/pgslot9.jpg" className="img-fluid" width="180px" height="241px" alt="pg slot" />
            </a>
            <div className="card-body">
              <strong>Galactic Gems</strong>
            </div>
          </div>
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            ...
            <div className="card-body">
              <strong>Guardians of Ice & Fire</strong>
            </div>
          </div>
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
          ...
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            ...
            <div className="card-body">
              <strong>Jack Frost's Winter</strong>
            </div>
          </div>
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            ...
            <div className="card-body">
              <strong>Jewels of Prosperity</strong>
            </div>
          </div>
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
          ...
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            ...
            <div className="card-body">
              <strong>Secrets of Cleopatra</strong>
            </div>
          </div>
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
          ...
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            ...
            <div className="card-body">
              <strong>Thai River Wonders</strong>
            </div>
          </div>
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            ...
            <div className="card-body">
              <strong>Majestic Treasures</strong>
            </div>
          </div>
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
          ...
          <div className="card m-1" style={{ width: "180px", padding: 0 }}>
            ...
            <div className="card-body">
              <strong>Ways of the Qilin</strong>
            </div>
          </div>
        </div>
      </div>
